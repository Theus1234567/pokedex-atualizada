...
<div class="container">     <!--Container mãe, o fundo branco-->
    ...
    <div class="content-list">      <!--O conteúdo da lista-->
        <h1 style="margin-bottom: 30px;"><strong>Cadastro de Pokémon</strong></h1>
        <form action="confirm.php" method="POST">
            <div class="form-group">
              <label for="nome">Nome</label>
              <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome do pokémon">
            </div>
            <div class="form-group">
              <label for="tipo">Tipo</label>
              <input type="text" class="form-control" id="tipo" name="tipo"  placeholder="Tipo do Pokémon">
            </div>
            <div class="form-group">
                <label for="regiao" style="margin: 0%;">Região</label>
            </div>
            <div class="input-group">
                <select class="custom-select" id="regiao" name="regiao" style="margin-bottom: 16px; margin-top: -4px;">
                  <option selected value="Erro!" class="erro-region">Escolher Região...</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="numero" name="numero" placeholder="Número do Pokémon">
            </div>
            <a href="confirm.php"><button type="submit" class="btn-confirm btn-primary">Confirmar</button></a>
        </form>
